...
const myFunction = async () => {
    const token = jwt.sign({_id: 'abc123'}, 'thisisnodecourse', {expiresIn: '7 days'})
...
// //The express lib call the json to send the response to front,
// //So we can control what we want to show using the toJson from this object
// pet.toJSON = function () {
//     return {}
// }